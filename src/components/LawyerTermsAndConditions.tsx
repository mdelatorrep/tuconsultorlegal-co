...
export const LawyerTermsAndConditions: React.FC<LawyerTermsAndConditionsProps> = ({ open, onAccept, onDecline }) => {
        ...
        <ScrollArea className="flex-1 pr-4">
          <div className="space-y-6 text-sm">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Para acceder a los servicios de suscripción, el usuario debe:</p>
                  <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    <li>
                      <strong>Suscripción Mensual:</strong> Pago automático cada 30 días
                    </li>
                    <li>
                      <strong>Suscripción Anual:</strong> Pago único anual con descuentos aplicables
                    </li>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    se cancelen con al menos 24 horas de anticipación a la fecha de renovación.
                  </p>
                </div>
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-muted-foreground">El abogado suscriptor se compromete a:</p>
                  <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    La información procesada a través de las herramientas está protegida por nuestras políticas de
                    privacidad y confidencialidad. El suscriptor se compromete a no compartir credenciales de acceso y a
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-muted-foreground">El servicio puede ser suspendido por:</p>
                  <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    El usuario puede cancelar su suscripción en cualquier momento a través de su panel de control. La
            ...
            <section>
              ...
              <p className="text-muted-foreground">Los suscriptores tienen acceso a:</p>
              <ul className="list-disc pl-6 mt-2 space-y-1 text-muted-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Estos términos pueden ser modificados con previo aviso de 30 días. Los cambios en precios se notificarán
                con 60 días de anticipación. El uso continuado del servicio constituye aceptación de las modificaciones.
              </p>
            </section>
        ...
        <div className="space-y-4 pt-4 border-t">
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-2">
              ...
              />
              <label htmlFor="subscription" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                He leído y acepto los <strong>Términos Específicos de Suscripción para Abogados</strong> y entiendo mi
                responsabilidad profesional en el uso de herramientas de IA
              </label>
            </div>
          </div>
          ...
          <div className="flex justify-between gap-3">
            ...
            <Button onClick={handleAccept} disabled={!agreedToTerms || !agreedToSubscription} className="flex-1">
              Aceptar y Continuar
            </Button>
          </div>
        </div>
